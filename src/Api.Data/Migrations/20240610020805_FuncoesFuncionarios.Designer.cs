...
namespace Data.Migrations
{
    ...
    [Migration("20240610020805_FuncoesFuncionarios")]
    partial class FuncoesFuncionarios
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(2461),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(2469)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(2471),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(2473)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(2475),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(2476)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 10, 2, 8, 4, 891, DateTimeKind.Utc).AddTicks(3713),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 10, 2, 8, 4, 891, DateTimeKind.Utc).AddTicks(3712)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 6, 10, 2, 8, 4, 891, DateTimeKind.Utc).AddTicks(3719),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 10, 2, 8, 4, 891, DateTimeKind.Utc).AddTicks(3719)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 10, 2, 8, 4, 891, DateTimeKind.Utc).AddTicks(1522),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 10, 2, 8, 4, 891, DateTimeKind.Utc).AddTicks(1518)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 6, 10, 2, 8, 4, 891, DateTimeKind.Utc).AddTicks(1543),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 10, 2, 8, 4, 891, DateTimeKind.Utc).AddTicks(1542)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.FormaPagamento.FormaPagamentoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 23, 8, 4, 895, DateTimeKind.Local).AddTicks(7576),
                            DescricaoFormaPg = "Dinheiro",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 23, 8, 4, 895, DateTimeKind.Local).AddTicks(7609)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PedidoSituacao.SituacaoPedidoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 23, 8, 4, 895, DateTimeKind.Local).AddTicks(8363),
                            DescricaoSituacao = "Aberto",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 23, 8, 4, 895, DateTimeKind.Local).AddTicks(8367)
                        },
                        new
                        {
                            Id = new Guid("185b07da-7e82-43d1-b61f-912d8b29a34c"),
                            CreateAt = new DateTime(2024, 6, 9, 23, 8, 4, 895, DateTimeKind.Local).AddTicks(8370),
                            DescricaoSituacao = "Fechado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 23, 8, 4, 895, DateTimeKind.Local).AddTicks(8371)
                        },
                        new
                        {
                            Id = new Guid("11b17cc5-c8b1-48f9-b9fd-886339441328"),
                            CreateAt = new DateTime(2024, 6, 9, 23, 8, 4, 895, DateTimeKind.Local).AddTicks(8373),
                            DescricaoSituacao = "Cancelado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 23, 8, 4, 895, DateTimeKind.Local).AddTicks(8373)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(1225),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(1229)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(1232),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(1232)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(1234),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(1235)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(1237),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 23, 8, 4, 892, DateTimeKind.Local).AddTicks(1238)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 23, 8, 4, 891, DateTimeKind.Local).AddTicks(9804),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 6, 9, 23, 8, 4, 891, DateTimeKind.Local).AddTicks(9816)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 10, 2, 8, 4, 891, DateTimeKind.Utc).AddTicks(2742),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 10, 2, 8, 4, 891, DateTimeKind.Utc).AddTicks(2752)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 6, 10, 2, 8, 4, 891, DateTimeKind.Utc).AddTicks(2753),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 10, 2, 8, 4, 891, DateTimeKind.Utc).AddTicks(2755)
                        });
                });
