...
namespace Data.Migrations
{
    ...
    [Migration("20240603055352_Pessoa")]
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(2355),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(2364)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(2366),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(2368)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(2370),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(2372)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 3, 5, 53, 52, 182, DateTimeKind.Utc).AddTicks(9363),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 5, 53, 52, 182, DateTimeKind.Utc).AddTicks(9360)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 6, 3, 5, 53, 52, 182, DateTimeKind.Utc).AddTicks(9445),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 5, 53, 52, 182, DateTimeKind.Utc).AddTicks(9444)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 3, 5, 53, 52, 182, DateTimeKind.Utc).AddTicks(5584),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 5, 53, 52, 182, DateTimeKind.Utc).AddTicks(5579)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 6, 3, 5, 53, 52, 182, DateTimeKind.Utc).AddTicks(5608),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 5, 53, 52, 182, DateTimeKind.Utc).AddTicks(5607)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.FormaPagamento.FormaPagamentoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 3, 2, 53, 52, 193, DateTimeKind.Local).AddTicks(8167),
                            DescricaoFormaPg = "Dinheiro",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 2, 53, 52, 193, DateTimeKind.Local).AddTicks(8220)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PedidoSituacao.SituacaoPedidoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 3, 2, 53, 52, 194, DateTimeKind.Local).AddTicks(356),
                            DescricaoSituacao = "Aberto",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 2, 53, 52, 194, DateTimeKind.Local).AddTicks(362)
                        },
                        new
                        {
                            Id = new Guid("185b07da-7e82-43d1-b61f-912d8b29a34c"),
                            CreateAt = new DateTime(2024, 6, 3, 2, 53, 52, 194, DateTimeKind.Local).AddTicks(365),
                            DescricaoSituacao = "Fechado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 2, 53, 52, 194, DateTimeKind.Local).AddTicks(366)
                        },
                        new
                        {
                            Id = new Guid("11b17cc5-c8b1-48f9-b9fd-886339441328"),
                            CreateAt = new DateTime(2024, 6, 3, 2, 53, 52, 194, DateTimeKind.Local).AddTicks(368),
                            DescricaoSituacao = "Cancelado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 2, 53, 52, 194, DateTimeKind.Local).AddTicks(369)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(687),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(692)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(696),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(698)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(712),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(714)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(716),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 2, 53, 52, 184, DateTimeKind.Local).AddTicks(718)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 3, 2, 53, 52, 183, DateTimeKind.Local).AddTicks(8959),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 6, 3, 2, 53, 52, 183, DateTimeKind.Local).AddTicks(8973)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 3, 5, 53, 52, 182, DateTimeKind.Utc).AddTicks(7758),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 5, 53, 52, 182, DateTimeKind.Utc).AddTicks(7766)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 6, 3, 5, 53, 52, 182, DateTimeKind.Utc).AddTicks(7768),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 3, 5, 53, 52, 182, DateTimeKind.Utc).AddTicks(7771)
                        });
                });
