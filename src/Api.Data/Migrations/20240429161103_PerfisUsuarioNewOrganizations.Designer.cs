...
namespace Data.Migrations
{
    ...
    [Migration("20240429161103_PerfisUsuarioNewOrganizations")]
    partial class PerfisUsuarioNewOrganizations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(3731),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(3738)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(3740),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(3751)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(3752),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(3761)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 16, 11, 2, 902, DateTimeKind.Utc).AddTicks(5945),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 11, 2, 902, DateTimeKind.Utc).AddTicks(5944)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 4, 29, 16, 11, 2, 902, DateTimeKind.Utc).AddTicks(5951),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 11, 2, 902, DateTimeKind.Utc).AddTicks(5951)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 16, 11, 2, 902, DateTimeKind.Utc).AddTicks(3922),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 11, 2, 902, DateTimeKind.Utc).AddTicks(3919)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 4, 29, 16, 11, 2, 902, DateTimeKind.Utc).AddTicks(3947),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 11, 2, 902, DateTimeKind.Utc).AddTicks(3946)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(2657),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(2661)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(2664),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(2665)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(2667),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(2668)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(2670),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(2672)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(1936),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 4, 29, 13, 11, 2, 903, DateTimeKind.Local).AddTicks(1947)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 16, 11, 2, 902, DateTimeKind.Utc).AddTicks(5127),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 11, 2, 902, DateTimeKind.Utc).AddTicks(5134)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 4, 29, 16, 11, 2, 902, DateTimeKind.Utc).AddTicks(5135),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 11, 2, 902, DateTimeKind.Utc).AddTicks(5137)
                        });
                });
