...
namespace Data.Migrations
{
    ...
    [Migration("20240425181116_HasDatas")]
    partial class HasDatas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 25, 15, 11, 16, 175, DateTimeKind.Local).AddTicks(375),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 15, 11, 16, 175, DateTimeKind.Local).AddTicks(384)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 4, 25, 15, 11, 16, 175, DateTimeKind.Local).AddTicks(386),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 15, 11, 16, 175, DateTimeKind.Local).AddTicks(388)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 4, 25, 15, 11, 16, 175, DateTimeKind.Local).AddTicks(389),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 15, 11, 16, 175, DateTimeKind.Local).AddTicks(391)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 25, 18, 11, 16, 174, DateTimeKind.Utc).AddTicks(2954),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 18, 11, 16, 174, DateTimeKind.Utc).AddTicks(2953)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 4, 25, 18, 11, 16, 174, DateTimeKind.Utc).AddTicks(2961),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 18, 11, 16, 174, DateTimeKind.Utc).AddTicks(2960)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 25, 18, 11, 16, 174, DateTimeKind.Utc).AddTicks(1363),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 18, 11, 16, 174, DateTimeKind.Utc).AddTicks(1359)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 4, 25, 18, 11, 16, 174, DateTimeKind.Utc).AddTicks(1382),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 18, 11, 16, 174, DateTimeKind.Utc).AddTicks(1381)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 25, 15, 11, 16, 174, DateTimeKind.Local).AddTicks(9495),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 15, 11, 16, 174, DateTimeKind.Local).AddTicks(9499)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 4, 25, 15, 11, 16, 174, DateTimeKind.Local).AddTicks(9503),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 15, 11, 16, 174, DateTimeKind.Local).AddTicks(9504)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 4, 25, 15, 11, 16, 174, DateTimeKind.Local).AddTicks(9506),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 15, 11, 16, 174, DateTimeKind.Local).AddTicks(9507)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 4, 25, 15, 11, 16, 174, DateTimeKind.Local).AddTicks(9508),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 15, 11, 16, 174, DateTimeKind.Local).AddTicks(9510)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 25, 15, 11, 16, 174, DateTimeKind.Local).AddTicks(8726),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 4, 25, 15, 11, 16, 174, DateTimeKind.Local).AddTicks(8742)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 25, 18, 11, 16, 174, DateTimeKind.Utc).AddTicks(2247),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 18, 11, 16, 174, DateTimeKind.Utc).AddTicks(2253)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 4, 25, 18, 11, 16, 174, DateTimeKind.Utc).AddTicks(2254),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 18, 11, 16, 174, DateTimeKind.Utc).AddTicks(2256)
                        });
                });
