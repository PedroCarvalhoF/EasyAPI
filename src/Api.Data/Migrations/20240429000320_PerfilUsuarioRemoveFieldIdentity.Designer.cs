...
namespace Data.Migrations
{
    ...
    [Migration("20240429000320_PerfilUsuarioRemoveFieldIdentity")]
    partial class PerfilUsuarioRemoveFieldIdentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(7342),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(7349)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(7351),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(7352)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(7353),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(7355)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 0, 3, 20, 86, DateTimeKind.Utc).AddTicks(6749),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 0, 3, 20, 86, DateTimeKind.Utc).AddTicks(6745)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 4, 29, 0, 3, 20, 86, DateTimeKind.Utc).AddTicks(6763),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 0, 3, 20, 86, DateTimeKind.Utc).AddTicks(6762)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 0, 3, 20, 86, DateTimeKind.Utc).AddTicks(1638),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 0, 3, 20, 86, DateTimeKind.Utc).AddTicks(1632)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 4, 29, 0, 3, 20, 86, DateTimeKind.Utc).AddTicks(1672),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 0, 3, 20, 86, DateTimeKind.Utc).AddTicks(1672)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(5999),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(6006)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(6009),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(6010)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(6012),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(6013)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(6024),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(6025)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(4756),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 4, 28, 21, 3, 20, 87, DateTimeKind.Local).AddTicks(4778)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 0, 3, 20, 86, DateTimeKind.Utc).AddTicks(4748),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 0, 3, 20, 86, DateTimeKind.Utc).AddTicks(4795)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 4, 29, 0, 3, 20, 86, DateTimeKind.Utc).AddTicks(4798),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 0, 3, 20, 86, DateTimeKind.Utc).AddTicks(4800)
                        });
                });
