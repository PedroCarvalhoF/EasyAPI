...
namespace Data.Migrations
{
    ...
    [Migration("20240512161503_Inicial")]
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 12, 13, 15, 3, 312, DateTimeKind.Local).AddTicks(507),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 13, 15, 3, 312, DateTimeKind.Local).AddTicks(524)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 5, 12, 13, 15, 3, 312, DateTimeKind.Local).AddTicks(526),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 13, 15, 3, 312, DateTimeKind.Local).AddTicks(529)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 5, 12, 13, 15, 3, 312, DateTimeKind.Local).AddTicks(546),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 13, 15, 3, 312, DateTimeKind.Local).AddTicks(548)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 12, 16, 15, 3, 310, DateTimeKind.Utc).AddTicks(3696),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 16, 15, 3, 310, DateTimeKind.Utc).AddTicks(3695)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 5, 12, 16, 15, 3, 310, DateTimeKind.Utc).AddTicks(3707),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 16, 15, 3, 310, DateTimeKind.Utc).AddTicks(3706)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 12, 16, 15, 3, 309, DateTimeKind.Utc).AddTicks(9934),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 16, 15, 3, 309, DateTimeKind.Utc).AddTicks(9930)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 5, 12, 16, 15, 3, 309, DateTimeKind.Utc).AddTicks(9955),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 16, 15, 3, 309, DateTimeKind.Utc).AddTicks(9954)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.FormaPagamento.FormaPagamentoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 12, 13, 15, 3, 320, DateTimeKind.Local).AddTicks(4188),
                            DescricaoFormaPg = "Dinheiro",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 13, 15, 3, 320, DateTimeKind.Local).AddTicks(4225)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PedidoSituacao.SituacaoPedidoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 12, 13, 15, 3, 320, DateTimeKind.Local).AddTicks(5594),
                            DescricaoSituacao = "Aberto",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 13, 15, 3, 320, DateTimeKind.Local).AddTicks(5600)
                        },
                        new
                        {
                            Id = new Guid("185b07da-7e82-43d1-b61f-912d8b29a34c"),
                            CreateAt = new DateTime(2024, 5, 12, 13, 15, 3, 320, DateTimeKind.Local).AddTicks(5607),
                            DescricaoSituacao = "Fechado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 13, 15, 3, 320, DateTimeKind.Local).AddTicks(5610)
                        },
                        new
                        {
                            Id = new Guid("11b17cc5-c8b1-48f9-b9fd-886339441328"),
                            CreateAt = new DateTime(2024, 5, 12, 13, 15, 3, 320, DateTimeKind.Local).AddTicks(5615),
                            DescricaoSituacao = "Cancelado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 13, 15, 3, 320, DateTimeKind.Local).AddTicks(5617)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 12, 13, 15, 3, 311, DateTimeKind.Local).AddTicks(8525),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 13, 15, 3, 311, DateTimeKind.Local).AddTicks(8532)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 5, 12, 13, 15, 3, 311, DateTimeKind.Local).AddTicks(8536),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 13, 15, 3, 311, DateTimeKind.Local).AddTicks(8538)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 5, 12, 13, 15, 3, 311, DateTimeKind.Local).AddTicks(8541),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 13, 15, 3, 311, DateTimeKind.Local).AddTicks(8542)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 5, 12, 13, 15, 3, 311, DateTimeKind.Local).AddTicks(8545),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 13, 15, 3, 311, DateTimeKind.Local).AddTicks(8546)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 12, 13, 15, 3, 311, DateTimeKind.Local).AddTicks(6424),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 5, 12, 13, 15, 3, 311, DateTimeKind.Local).AddTicks(6458)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 12, 16, 15, 3, 310, DateTimeKind.Utc).AddTicks(1863),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 16, 15, 3, 310, DateTimeKind.Utc).AddTicks(1892)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 5, 12, 16, 15, 3, 310, DateTimeKind.Utc).AddTicks(1895),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 12, 16, 15, 3, 310, DateTimeKind.Utc).AddTicks(1898)
                        });
                });
