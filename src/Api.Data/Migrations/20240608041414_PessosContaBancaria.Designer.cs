...
namespace Data.Migrations
{
    ...
    [Migration("20240608041414_PessosContaBancaria")]
    partial class PessosContaBancaria
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(4614),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(4621)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(4623),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(4624)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(4626),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(4627)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 8, 4, 14, 13, 585, DateTimeKind.Utc).AddTicks(6642),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 4, 14, 13, 585, DateTimeKind.Utc).AddTicks(6641)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 6, 8, 4, 14, 13, 585, DateTimeKind.Utc).AddTicks(6649),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 4, 14, 13, 585, DateTimeKind.Utc).AddTicks(6649)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 8, 4, 14, 13, 585, DateTimeKind.Utc).AddTicks(4648),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 4, 14, 13, 585, DateTimeKind.Utc).AddTicks(4642)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 6, 8, 4, 14, 13, 585, DateTimeKind.Utc).AddTicks(4669),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 4, 14, 13, 585, DateTimeKind.Utc).AddTicks(4668)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.FormaPagamento.FormaPagamentoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 8, 1, 14, 13, 589, DateTimeKind.Local).AddTicks(4205),
                            DescricaoFormaPg = "Dinheiro",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 1, 14, 13, 589, DateTimeKind.Local).AddTicks(4226)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PedidoSituacao.SituacaoPedidoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 8, 1, 14, 13, 589, DateTimeKind.Local).AddTicks(5103),
                            DescricaoSituacao = "Aberto",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 1, 14, 13, 589, DateTimeKind.Local).AddTicks(5108)
                        },
                        new
                        {
                            Id = new Guid("185b07da-7e82-43d1-b61f-912d8b29a34c"),
                            CreateAt = new DateTime(2024, 6, 8, 1, 14, 13, 589, DateTimeKind.Local).AddTicks(5110),
                            DescricaoSituacao = "Fechado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 1, 14, 13, 589, DateTimeKind.Local).AddTicks(5111)
                        },
                        new
                        {
                            Id = new Guid("11b17cc5-c8b1-48f9-b9fd-886339441328"),
                            CreateAt = new DateTime(2024, 6, 8, 1, 14, 13, 589, DateTimeKind.Local).AddTicks(5113),
                            DescricaoSituacao = "Cancelado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 1, 14, 13, 589, DateTimeKind.Local).AddTicks(5114)
                        });
                });

            modelBuilder.Entity("Domain.Entities.Pessoa.Pessoas.DadosBancariosEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(3617),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(3622)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(3624),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(3625)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(3627),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(3628)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(3630),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(3630)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(2179),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 6, 8, 1, 14, 13, 586, DateTimeKind.Local).AddTicks(2191)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 8, 4, 14, 13, 585, DateTimeKind.Utc).AddTicks(5808),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 4, 14, 13, 585, DateTimeKind.Utc).AddTicks(5813)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 6, 8, 4, 14, 13, 585, DateTimeKind.Utc).AddTicks(5824),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 8, 4, 14, 13, 585, DateTimeKind.Utc).AddTicks(5825)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Pessoa.Pessoas.PessoaDadosBancariosEntity", b =>
                {
                    b.HasOne("Domain.Entities.Pessoa.Pessoas.DadosBancariosEntity", "DadosBancariosEntity")
