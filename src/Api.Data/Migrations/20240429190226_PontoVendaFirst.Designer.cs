...
namespace Data.Migrations
{
    ...
    [Migration("20240429190226_PontoVendaFirst")]
    partial class PontoVendaFirst
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(4090),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(4098)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(4100),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(4102)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(4103),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(4105)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 19, 2, 26, 230, DateTimeKind.Utc).AddTicks(6710),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 19, 2, 26, 230, DateTimeKind.Utc).AddTicks(6709)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 4, 29, 19, 2, 26, 230, DateTimeKind.Utc).AddTicks(6717),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 19, 2, 26, 230, DateTimeKind.Utc).AddTicks(6716)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 19, 2, 26, 230, DateTimeKind.Utc).AddTicks(5013),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 19, 2, 26, 230, DateTimeKind.Utc).AddTicks(5009)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 4, 29, 19, 2, 26, 230, DateTimeKind.Utc).AddTicks(5035),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 19, 2, 26, 230, DateTimeKind.Utc).AddTicks(5033)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(3292),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(3296)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(3298),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(3299)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(3301),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(3302)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(3305),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(3307)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(2583),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 4, 29, 16, 2, 26, 231, DateTimeKind.Local).AddTicks(2594)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 29, 19, 2, 26, 230, DateTimeKind.Utc).AddTicks(6031),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 19, 2, 26, 230, DateTimeKind.Utc).AddTicks(6037)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 4, 29, 19, 2, 26, 230, DateTimeKind.Utc).AddTicks(6039),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 29, 19, 2, 26, 230, DateTimeKind.Utc).AddTicks(6041)
                        });
                });
