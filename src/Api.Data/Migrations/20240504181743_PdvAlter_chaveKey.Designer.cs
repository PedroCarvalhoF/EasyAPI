...
namespace Data.Migrations
{
    ...
    [Migration("20240504181743_PdvAlter_chaveKey")]
    partial class PdvAlter_chaveKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(8791),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(8827)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(8829),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(8833)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(8834),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(8839)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 18, 17, 43, 261, DateTimeKind.Utc).AddTicks(3441),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 18, 17, 43, 261, DateTimeKind.Utc).AddTicks(3440)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 5, 4, 18, 17, 43, 261, DateTimeKind.Utc).AddTicks(3452),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 18, 17, 43, 261, DateTimeKind.Utc).AddTicks(3451)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 18, 17, 43, 261, DateTimeKind.Utc).AddTicks(228),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 18, 17, 43, 261, DateTimeKind.Utc).AddTicks(223)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 5, 4, 18, 17, 43, 261, DateTimeKind.Utc).AddTicks(254),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 18, 17, 43, 261, DateTimeKind.Utc).AddTicks(253)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.FormaPagamento.FormaPagamentoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 15, 17, 43, 269, DateTimeKind.Local).AddTicks(6346),
                            DescricaoFormaPg = "Dinheiro",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 17, 43, 269, DateTimeKind.Local).AddTicks(6385)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PedidoSituacao.SituacaoPedidoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 15, 17, 43, 269, DateTimeKind.Local).AddTicks(7411),
                            DescricaoSituacao = "Aberto",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 17, 43, 269, DateTimeKind.Local).AddTicks(7422)
                        },
                        new
                        {
                            Id = new Guid("185b07da-7e82-43d1-b61f-912d8b29a34c"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 17, 43, 269, DateTimeKind.Local).AddTicks(7426),
                            DescricaoSituacao = "Fechado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 17, 43, 269, DateTimeKind.Local).AddTicks(7427)
                        },
                        new
                        {
                            Id = new Guid("11b17cc5-c8b1-48f9-b9fd-886339441328"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 17, 43, 269, DateTimeKind.Local).AddTicks(7431),
                            DescricaoSituacao = "Cancelado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 17, 43, 269, DateTimeKind.Local).AddTicks(7432)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(5555),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(5566)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(5570),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(5571)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(5577),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(5578)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(5581),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(5582)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(4164),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 5, 4, 15, 17, 43, 262, DateTimeKind.Local).AddTicks(4181)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 18, 17, 43, 261, DateTimeKind.Utc).AddTicks(1853),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 18, 17, 43, 261, DateTimeKind.Utc).AddTicks(1864)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 5, 4, 18, 17, 43, 261, DateTimeKind.Utc).AddTicks(1866),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 18, 17, 43, 261, DateTimeKind.Utc).AddTicks(1870)
                        });
                });
