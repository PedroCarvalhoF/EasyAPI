...
namespace Data.Migrations
{
    ...
    [Migration("20240504181835_perfil_usuario_key")]
    partial class perfil_usuario_key
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(7540),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(7547)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(7549),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(7551)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(7552),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(7554)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 18, 18, 34, 708, DateTimeKind.Utc).AddTicks(8299),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 18, 18, 34, 708, DateTimeKind.Utc).AddTicks(8298)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 5, 4, 18, 18, 34, 708, DateTimeKind.Utc).AddTicks(8308),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 18, 18, 34, 708, DateTimeKind.Utc).AddTicks(8307)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 18, 18, 34, 708, DateTimeKind.Utc).AddTicks(4517),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 18, 18, 34, 708, DateTimeKind.Utc).AddTicks(4512)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 5, 4, 18, 18, 34, 708, DateTimeKind.Utc).AddTicks(4546),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 18, 18, 34, 708, DateTimeKind.Utc).AddTicks(4546)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.FormaPagamento.FormaPagamentoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 15, 18, 34, 715, DateTimeKind.Local).AddTicks(7012),
                            DescricaoFormaPg = "Dinheiro",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 18, 34, 715, DateTimeKind.Local).AddTicks(7052)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PedidoSituacao.SituacaoPedidoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 15, 18, 34, 715, DateTimeKind.Local).AddTicks(7902),
                            DescricaoSituacao = "Aberto",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 18, 34, 715, DateTimeKind.Local).AddTicks(7906)
                        },
                        new
                        {
                            Id = new Guid("185b07da-7e82-43d1-b61f-912d8b29a34c"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 18, 34, 715, DateTimeKind.Local).AddTicks(7910),
                            DescricaoSituacao = "Fechado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 18, 34, 715, DateTimeKind.Local).AddTicks(7911)
                        },
                        new
                        {
                            Id = new Guid("11b17cc5-c8b1-48f9-b9fd-886339441328"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 18, 34, 715, DateTimeKind.Local).AddTicks(7915),
                            DescricaoSituacao = "Cancelado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 18, 34, 715, DateTimeKind.Local).AddTicks(7916)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(6731),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(6736)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(6739),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(6740)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(6742),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(6743)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(6745),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(6746)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(5824),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 5, 4, 15, 18, 34, 709, DateTimeKind.Local).AddTicks(5836)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 4, 18, 18, 34, 708, DateTimeKind.Utc).AddTicks(7002),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 18, 18, 34, 708, DateTimeKind.Utc).AddTicks(7024)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 5, 4, 18, 18, 34, 708, DateTimeKind.Utc).AddTicks(7026),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 4, 18, 18, 34, 708, DateTimeKind.Utc).AddTicks(7030)
                        });
                });
