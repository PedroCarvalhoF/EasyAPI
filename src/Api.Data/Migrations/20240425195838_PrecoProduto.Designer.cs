...
namespace Data.Migrations
{
    ...
    [Migration("20240425195838_PrecoProduto")]
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(8231),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(8244)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(8246),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(8249)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(8252),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(8255)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 25, 19, 58, 37, 838, DateTimeKind.Utc).AddTicks(2877),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 19, 58, 37, 838, DateTimeKind.Utc).AddTicks(2869)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 4, 25, 19, 58, 37, 838, DateTimeKind.Utc).AddTicks(2898),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 19, 58, 37, 838, DateTimeKind.Utc).AddTicks(2897)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 25, 19, 58, 37, 837, DateTimeKind.Utc).AddTicks(7574),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 19, 58, 37, 837, DateTimeKind.Utc).AddTicks(7568)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 4, 25, 19, 58, 37, 837, DateTimeKind.Utc).AddTicks(7600),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 19, 58, 37, 837, DateTimeKind.Utc).AddTicks(7599)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(6393),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(6400)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(6404),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(6405)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(6407),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(6408)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(6410),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(6412)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(4918),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 4, 25, 16, 58, 37, 839, DateTimeKind.Local).AddTicks(4934)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 25, 19, 58, 37, 837, DateTimeKind.Utc).AddTicks(9801),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 19, 58, 37, 837, DateTimeKind.Utc).AddTicks(9825)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 4, 25, 19, 58, 37, 837, DateTimeKind.Utc).AddTicks(9827),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 25, 19, 58, 37, 837, DateTimeKind.Utc).AddTicks(9830)
                        });
                });
