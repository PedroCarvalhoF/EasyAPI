...
namespace Data.Migrations
{
    ...
    [Migration("20240420165157_RenomeacaoTabelas")]
    partial class RenomeacaoTabelas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Domain.Entities.Pessoa.PessoaTipo.PessoaTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4063),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4067),
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.ToTable("ProdutoMedidas");

                    b.HasData(
                        new
                        {
                            Id = new Guid("cc8119c5-7651-4708-bba4-8f350726bdac"),
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4134),
                            Descricao = "Litro",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4136)
                        },
                        new
                        {
                            Id = new Guid("9bbe9cc9-ba40-4bb3-9b71-74a8234133a5"),
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4139),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4140)
                        },
                        new
                        {
                            Id = new Guid("05b3382d-0940-446a-8c2c-3e27293cf77d"),
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4144),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4145)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3271),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true
                        },
                        new
                        {
                            Id = new Guid("89d8c87f-b473-485e-90a3-d193dcac7e16"),
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3321),
                            DescricaoCategoria = "Promoções",
                            Habilitado = true
                        },
                        new
                        {
                            Id = new Guid("8666313b-bb19-462a-9659-79d6b5c7059e"),
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3351),
            ...
            modelBuilder.Entity("Domain.Entities.FormaPagamento.FormaPagamentoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3951),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3955),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3958),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3960),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3963),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3966),
                            DescricaoFormaPg = "VR",
                            Habilitado = true
                        },
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3968),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3971),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3974),
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3866),
                            ...
                            UpdateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(3882)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4197),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4199)
                        },
                        new
                        {
                            Id = new Guid("3cca7caf-8a98-40b2-9f20-3f864f59e1c5"),
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4203),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4204)
                        },
                        new
                        {
                            Id = new Guid("59de4011-1ca7-4a52-833c-9672a03320ac"),
                            CreateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4207),
                            DescricaoTipoProduto = "Ambos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 20, 13, 51, 57, 174, DateTimeKind.Local).AddTicks(4209)
                        });
                });
