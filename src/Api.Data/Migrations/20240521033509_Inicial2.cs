    ...
    public partial class Inicial2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"), new DateTime(2024, 5, 21, 0, 35, 9, 87, DateTimeKind.Local).AddTicks(790), "IFood", true, new DateTime(2024, 5, 21, 0, 35, 9, 87, DateTimeKind.Local).AddTicks(792) },
                    { new Guid("710bd8dd-1853-43a1-8708-ca1f259d71ad"), new DateTime(2024, 5, 21, 0, 35, 9, 87, DateTimeKind.Local).AddTicks(769), "Balcão", true, new DateTime(2024, 5, 21, 0, 35, 9, 87, DateTimeKind.Local).AddTicks(788) },
                    { new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"), new DateTime(2024, 5, 21, 0, 35, 9, 87, DateTimeKind.Local).AddTicks(794), "Lojista", true, new DateTime(2024, 5, 21, 0, 35, 9, 87, DateTimeKind.Local).AddTicks(797) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a9b05f16-71f0-4f77-a653-52c1a15b36bc"), new DateTime(2024, 5, 21, 3, 35, 9, 85, DateTimeKind.Utc).AddTicks(1179), "Executivos", true, new DateTime(2024, 5, 21, 3, 35, 9, 85, DateTimeKind.Utc).AddTicks(1174) },
                    { new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"), new DateTime(2024, 5, 21, 3, 35, 9, 85, DateTimeKind.Utc).AddTicks(1211), "Bebidas", true, new DateTime(2024, 5, 21, 3, 35, 9, 85, DateTimeKind.Utc).AddTicks(1210) }
                });

            migrationBuilder.InsertData(
                table: "FormasPagamentos",
                columns: new[] { "Id", "CreateAt", "DescricaoFormaPg", "Habilitado", "UpdateAt" },
                values: new object[] { new Guid("92008957-f185-4563-9d9e-7b71f4ea2691"), new DateTime(2024, 5, 21, 0, 35, 9, 94, DateTimeKind.Local).AddTicks(3001), "Dinheiro", true, new DateTime(2024, 5, 21, 0, 35, 9, 94, DateTimeKind.Local).AddTicks(3039) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("567906bb-6eb4-42e9-b890-10e6da214766"), new DateTime(2024, 5, 21, 0, 35, 9, 86, DateTimeKind.Local).AddTicks(9125), "Almoço", true, new DateTime(2024, 5, 21, 0, 35, 9, 86, DateTimeKind.Local).AddTicks(9139) },
                    { new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"), new DateTime(2024, 5, 21, 0, 35, 9, 86, DateTimeKind.Local).AddTicks(9150), "Noturno", true, new DateTime(2024, 5, 21, 0, 35, 9, 86, DateTimeKind.Local).AddTicks(9151) },
                    { new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"), new DateTime(2024, 5, 21, 0, 35, 9, 86, DateTimeKind.Local).AddTicks(9146), "Dia Todo", true, new DateTime(2024, 5, 21, 0, 35, 9, 86, DateTimeKind.Local).AddTicks(9148) },
                    { new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"), new DateTime(2024, 5, 21, 0, 35, 9, 86, DateTimeKind.Local).AddTicks(9143), "Janta", true, new DateTime(2024, 5, 21, 0, 35, 9, 86, DateTimeKind.Local).AddTicks(9144) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"), new DateTime(2024, 5, 21, 3, 35, 9, 85, DateTimeKind.Utc).AddTicks(4364), "Caixa", true, new DateTime(2024, 5, 21, 3, 35, 9, 85, DateTimeKind.Utc).AddTicks(4363) },
                    { new Guid("414a646f-1146-4b6d-bbfc-39a26e74a091"), new DateTime(2024, 5, 21, 3, 35, 9, 85, DateTimeKind.Utc).AddTicks(4355), "Unidade", true, new DateTime(2024, 5, 21, 3, 35, 9, 85, DateTimeKind.Utc).AddTicks(4352) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11b17cc5-c8b1-48f9-b9fd-886339441328"), new DateTime(2024, 5, 21, 0, 35, 9, 94, DateTimeKind.Local).AddTicks(3958), "Cancelado", true, new DateTime(2024, 5, 21, 0, 35, 9, 94, DateTimeKind.Local).AddTicks(3959) },
                    { new Guid("185b07da-7e82-43d1-b61f-912d8b29a34c"), new DateTime(2024, 5, 21, 0, 35, 9, 94, DateTimeKind.Local).AddTicks(3955), "Fechado", true, new DateTime(2024, 5, 21, 0, 35, 9, 94, DateTimeKind.Local).AddTicks(3956) },
                    { new Guid("abc0f0f9-3295-439c-a468-795b071b7f22"), new DateTime(2024, 5, 21, 0, 35, 9, 94, DateTimeKind.Local).AddTicks(3947), "Aberto", true, new DateTime(2024, 5, 21, 0, 35, 9, 94, DateTimeKind.Local).AddTicks(3952) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"), new DateTime(2024, 5, 21, 3, 35, 9, 85, DateTimeKind.Utc).AddTicks(3202), "Materia Prima", true, new DateTime(2024, 5, 21, 3, 35, 9, 85, DateTimeKind.Utc).AddTicks(3204) },
                    { new Guid("edddccfa-a4af-4831-b9ee-29bdd5f755af"), new DateTime(2024, 5, 21, 3, 35, 9, 85, DateTimeKind.Utc).AddTicks(3186), "Venda", true, new DateTime(2024, 5, 21, 3, 35, 9, 85, DateTimeKind.Utc).AddTicks(3200) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("f0e75a80-0b64-4b2b-9f53-f3dce3f6d126"), new Guid("a9b05f16-71f0-4f77-a653-52c1a15b36bc"), "01", new DateTime(2024, 5, 21, 0, 35, 9, 86, DateTimeKind.Local).AddTicks(6153), "", true, "", "Agua sem gas", "", new Guid("414a646f-1146-4b6d-bbfc-39a26e74a091"), new Guid("edddccfa-a4af-4831-b9ee-29bdd5f755af"), new DateTime(2024, 5, 21, 0, 35, 9, 86, DateTimeKind.Local).AddTicks(6175) });
