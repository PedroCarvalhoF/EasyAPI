...
namespace Data.Migrations
{
    ...
    [Migration("20240609140617_PessoaContato")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 11, 6, 16, 668, DateTimeKind.Local).AddTicks(2748),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 11, 6, 16, 668, DateTimeKind.Local).AddTicks(2781)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 6, 9, 11, 6, 16, 668, DateTimeKind.Local).AddTicks(2783),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 11, 6, 16, 668, DateTimeKind.Local).AddTicks(2786)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 6, 9, 11, 6, 16, 668, DateTimeKind.Local).AddTicks(2788),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 11, 6, 16, 668, DateTimeKind.Local).AddTicks(2790)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 14, 6, 16, 665, DateTimeKind.Utc).AddTicks(9080),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 14, 6, 16, 665, DateTimeKind.Utc).AddTicks(9075)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 6, 9, 14, 6, 16, 665, DateTimeKind.Utc).AddTicks(9098),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 14, 6, 16, 665, DateTimeKind.Utc).AddTicks(9097)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 14, 6, 16, 665, DateTimeKind.Utc).AddTicks(2976),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 14, 6, 16, 665, DateTimeKind.Utc).AddTicks(2970)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 6, 9, 14, 6, 16, 665, DateTimeKind.Utc).AddTicks(3007),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 14, 6, 16, 665, DateTimeKind.Utc).AddTicks(3006)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.FormaPagamento.FormaPagamentoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 11, 6, 16, 676, DateTimeKind.Local).AddTicks(9590),
                            DescricaoFormaPg = "Dinheiro",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 11, 6, 16, 676, DateTimeKind.Local).AddTicks(9654)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PedidoSituacao.SituacaoPedidoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 11, 6, 16, 677, DateTimeKind.Local).AddTicks(1161),
                            DescricaoSituacao = "Aberto",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 11, 6, 16, 677, DateTimeKind.Local).AddTicks(1169)
                        },
                        new
                        {
                            Id = new Guid("185b07da-7e82-43d1-b61f-912d8b29a34c"),
                            CreateAt = new DateTime(2024, 6, 9, 11, 6, 16, 677, DateTimeKind.Local).AddTicks(1174),
                            DescricaoSituacao = "Fechado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 11, 6, 16, 677, DateTimeKind.Local).AddTicks(1176)
                        },
                        new
                        {
                            Id = new Guid("11b17cc5-c8b1-48f9-b9fd-886339441328"),
                            CreateAt = new DateTime(2024, 6, 9, 11, 6, 16, 677, DateTimeKind.Local).AddTicks(1182),
                            DescricaoSituacao = "Cancelado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 11, 6, 16, 677, DateTimeKind.Local).AddTicks(1183)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Pessoa.Pessoas.PessoaDadosBancariosEntity", b =>
                {
                    b.Property<Guid>("PessoaEntityId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Domain.Entities.Pessoa.Pessoas.PessoaEnderecoEntity", b =>
                {
                    b.Property<Guid>("PessoaEntityId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 11, 6, 16, 667, DateTimeKind.Local).AddTicks(9721),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 11, 6, 16, 667, DateTimeKind.Local).AddTicks(9738)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 6, 9, 11, 6, 16, 667, DateTimeKind.Local).AddTicks(9742),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 11, 6, 16, 667, DateTimeKind.Local).AddTicks(9744)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 6, 9, 11, 6, 16, 667, DateTimeKind.Local).AddTicks(9746),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 11, 6, 16, 667, DateTimeKind.Local).AddTicks(9747)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 6, 9, 11, 6, 16, 667, DateTimeKind.Local).AddTicks(9753),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 11, 6, 16, 667, DateTimeKind.Local).AddTicks(9754)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 11, 6, 16, 667, DateTimeKind.Local).AddTicks(5666),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 6, 9, 11, 6, 16, 667, DateTimeKind.Local).AddTicks(5694)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 9, 14, 6, 16, 665, DateTimeKind.Utc).AddTicks(6856),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 14, 6, 16, 665, DateTimeKind.Utc).AddTicks(6888)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 6, 9, 14, 6, 16, 665, DateTimeKind.Utc).AddTicks(6890),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 9, 14, 6, 16, 665, DateTimeKind.Utc).AddTicks(6893)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Pessoa.PessoaContato.PessoaContatoEntity", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Pessoa.Pessoas.PessoaEntity", "PessoaEntity")
                        .WithMany("PessoaContatos")
