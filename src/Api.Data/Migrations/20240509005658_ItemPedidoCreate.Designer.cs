...
namespace Data.Migrations
{
    ...
    [Migration("20240509005658_ItemPedidoCreate")]
    partial class ItemPedidoCreate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 8, 21, 56, 57, 677, DateTimeKind.Local).AddTicks(134),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 8, 21, 56, 57, 677, DateTimeKind.Local).AddTicks(149)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 5, 8, 21, 56, 57, 677, DateTimeKind.Local).AddTicks(152),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 8, 21, 56, 57, 677, DateTimeKind.Local).AddTicks(155)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 5, 8, 21, 56, 57, 677, DateTimeKind.Local).AddTicks(157),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 8, 21, 56, 57, 677, DateTimeKind.Local).AddTicks(160)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 9, 0, 56, 57, 675, DateTimeKind.Utc).AddTicks(4717),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 9, 0, 56, 57, 675, DateTimeKind.Utc).AddTicks(4715)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 5, 9, 0, 56, 57, 675, DateTimeKind.Utc).AddTicks(4732),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 9, 0, 56, 57, 675, DateTimeKind.Utc).AddTicks(4731)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 9, 0, 56, 57, 675, DateTimeKind.Utc).AddTicks(1282),
                            DescricaoCategoria = "Executivos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 9, 0, 56, 57, 675, DateTimeKind.Utc).AddTicks(1276)
                        },
                        new
                        {
                            Id = new Guid("d9d229c4-9a64-4836-af41-2f111f229c46"),
                            CreateAt = new DateTime(2024, 5, 9, 0, 56, 57, 675, DateTimeKind.Utc).AddTicks(1318),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 9, 0, 56, 57, 675, DateTimeKind.Utc).AddTicks(1317)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.FormaPagamento.FormaPagamentoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 8, 21, 56, 57, 685, DateTimeKind.Local).AddTicks(5668),
                            DescricaoFormaPg = "Dinheiro",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 8, 21, 56, 57, 685, DateTimeKind.Local).AddTicks(5717)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PedidoSituacao.SituacaoPedidoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 8, 21, 56, 57, 685, DateTimeKind.Local).AddTicks(7026),
                            DescricaoSituacao = "Aberto",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 8, 21, 56, 57, 685, DateTimeKind.Local).AddTicks(7037)
                        },
                        new
                        {
                            Id = new Guid("185b07da-7e82-43d1-b61f-912d8b29a34c"),
                            CreateAt = new DateTime(2024, 5, 8, 21, 56, 57, 685, DateTimeKind.Local).AddTicks(7043),
                            DescricaoSituacao = "Fechado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 8, 21, 56, 57, 685, DateTimeKind.Local).AddTicks(7044)
                        },
                        new
                        {
                            Id = new Guid("11b17cc5-c8b1-48f9-b9fd-886339441328"),
                            CreateAt = new DateTime(2024, 5, 8, 21, 56, 57, 685, DateTimeKind.Local).AddTicks(7047),
                            DescricaoSituacao = "Cancelado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 8, 21, 56, 57, 685, DateTimeKind.Local).AddTicks(7048)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 8, 21, 56, 57, 676, DateTimeKind.Local).AddTicks(8801),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 8, 21, 56, 57, 676, DateTimeKind.Local).AddTicks(8808)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 5, 8, 21, 56, 57, 676, DateTimeKind.Local).AddTicks(8812),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 8, 21, 56, 57, 676, DateTimeKind.Local).AddTicks(8813)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 5, 8, 21, 56, 57, 676, DateTimeKind.Local).AddTicks(8815),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 8, 21, 56, 57, 676, DateTimeKind.Local).AddTicks(8817)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 5, 8, 21, 56, 57, 676, DateTimeKind.Local).AddTicks(8819),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 8, 21, 56, 57, 676, DateTimeKind.Local).AddTicks(8821)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 8, 21, 56, 57, 676, DateTimeKind.Local).AddTicks(7413),
                            Descricao = "",
                            Habilitado = true,
                            ImgUrl = "",
                            ...
                            UpdateAt = new DateTime(2024, 5, 8, 21, 56, 57, 676, DateTimeKind.Local).AddTicks(7427)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 5, 9, 0, 56, 57, 675, DateTimeKind.Utc).AddTicks(3251),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 9, 0, 56, 57, 675, DateTimeKind.Utc).AddTicks(3264)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 5, 9, 0, 56, 57, 675, DateTimeKind.Utc).AddTicks(3266),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 5, 9, 0, 56, 57, 675, DateTimeKind.Utc).AddTicks(3269)
                        });
                });
