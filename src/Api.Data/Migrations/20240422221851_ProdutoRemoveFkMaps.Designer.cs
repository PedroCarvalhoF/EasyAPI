...
namespace Data.Migrations
{
    ...
    [Migration("20240422221851_ProdutoRemoveFkMaps")]
    partial class ProdutoRemoveFkMaps
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Domain.Entities.Pessoa.PessoaTipo.PessoaTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9012),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9016),
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9050),
                            Descricao = "Litro",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9051)
                        },
                        new
                        {
                            Id = new Guid("9bbe9cc9-ba40-4bb3-9b71-74a8234133a5"),
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9058),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9059)
                        },
                        new
                        {
                            Id = new Guid("05b3382d-0940-446a-8c2c-3e27293cf77d"),
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9062),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9063)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaProduto.CategoriaProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8312),
                            DescricaoCategoria = "Bebidas",
                            Habilitado = true
                        },
                        new
                        {
                            Id = new Guid("2d4f8523-e39e-4238-8b64-812bec73b76b"),
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8357),
                            DescricaoCategoria = "Promoções",
                            Habilitado = true
                        },
                        new
                        {
                            Id = new Guid("1c8dd23e-47df-4c61-896c-8f8edca9d644"),
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8391),
            ...
            modelBuilder.Entity("Domain.Entities.FormaPagamento.FormaPagamentoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8911),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8921),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8924),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8927),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8930),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8933),
                            DescricaoFormaPg = "VR",
                            Habilitado = true
                        },
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8936),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8939),
                        ...
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8953),
            ...
            modelBuilder.Entity("Domain.Entities.Produto.ProdutoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8854),
                            ...
                            UpdateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(8864)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9098),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9099)
                        },
                        new
                        {
                            Id = new Guid("3cca7caf-8a98-40b2-9f20-3f864f59e1c5"),
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9103),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9104)
                        },
                        new
                        {
                            Id = new Guid("59de4011-1ca7-4a52-833c-9672a03320ac"),
                            CreateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9107),
                            DescricaoTipoProduto = "Ambos",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 4, 22, 19, 18, 50, 380, DateTimeKind.Local).AddTicks(9108)
                        });
                });
