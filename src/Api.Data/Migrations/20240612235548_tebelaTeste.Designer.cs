...
namespace Data.Migrations
{
    ...
    [Migration("20240612235548_tebelaTeste")]
    partial class tebelaTeste
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.Domain.Entities.CategoriaPreco.CategoriaPrecoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(6493),
                            DescricaoCategoria = "Balcão",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(6502)
                        },
                        new
                        {
                            Id = new Guid("5533b87c-72d5-4033-85c4-ae44f5a3210c"),
                            CreateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(6504),
                            DescricaoCategoria = "IFood",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(6505)
                        },
                        new
                        {
                            Id = new Guid("ed65a4e3-a0b0-40a7-b7ae-3397a965d924"),
                            CreateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(6507),
                            DescricaoCategoria = "Lojista",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(6508)
                        });
                });
            ...
            modelBuilder.Entity("Api.Domain.Entities.ProdutoMedida.ProdutoMedidaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 12, 23, 55, 48, 374, DateTimeKind.Utc).AddTicks(8991),
                            Descricao = "Unidade",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 23, 55, 48, 374, DateTimeKind.Utc).AddTicks(8989)
                        },
                        new
                        {
                            Id = new Guid("2f943e86-f06f-4f7d-babf-48d0d2d8f3ac"),
                            CreateAt = new DateTime(2024, 6, 12, 23, 55, 48, 374, DateTimeKind.Utc).AddTicks(8997),
                            Descricao = "Caixa",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 23, 55, 48, 374, DateTimeKind.Utc).AddTicks(8996)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.FormaPagamento.FormaPagamentoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 12, 20, 55, 48, 382, DateTimeKind.Local).AddTicks(2694),
                            DescricaoFormaPg = "Dinheiro",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 20, 55, 48, 382, DateTimeKind.Local).AddTicks(2728)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PedidoSituacao.SituacaoPedidoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 12, 20, 55, 48, 382, DateTimeKind.Local).AddTicks(3439),
                            DescricaoSituacao = "Aberto",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 20, 55, 48, 382, DateTimeKind.Local).AddTicks(3444)
                        },
                        new
                        {
                            Id = new Guid("185b07da-7e82-43d1-b61f-912d8b29a34c"),
                            CreateAt = new DateTime(2024, 6, 12, 20, 55, 48, 382, DateTimeKind.Local).AddTicks(3447),
                            DescricaoSituacao = "Fechado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 20, 55, 48, 382, DateTimeKind.Local).AddTicks(3448)
                        },
                        new
                        {
                            Id = new Guid("11b17cc5-c8b1-48f9-b9fd-886339441328"),
                            CreateAt = new DateTime(2024, 6, 12, 20, 55, 48, 382, DateTimeKind.Local).AddTicks(3451),
                            DescricaoSituacao = "Cancelado",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 20, 55, 48, 382, DateTimeKind.Local).AddTicks(3451)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.PontoVendaPeriodoVenda.PeriodoPontoVendaEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(5735),
                            DescricaoPeriodo = "Almoço",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(5746)
                        },
                        new
                        {
                            Id = new Guid("fc6a5d67-8356-4270-b9e6-7749b553dcf3"),
                            CreateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(5749),
                            DescricaoPeriodo = "Janta",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(5750)
                        },
                        new
                        {
                            Id = new Guid("f14c83df-1fa4-4a83-8070-b16ecb19aa77"),
                            CreateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(5758),
                            DescricaoPeriodo = "Dia Todo",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(5759)
                        },
                        new
                        {
                            Id = new Guid("7e107de8-c97a-435b-9976-7a689ca28bb7"),
                            CreateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(5760),
                            DescricaoPeriodo = "Noturno",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 20, 55, 48, 375, DateTimeKind.Local).AddTicks(5761)
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.ProdutoTipo.ProdutoTipoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateAt = new DateTime(2024, 6, 12, 23, 55, 48, 374, DateTimeKind.Utc).AddTicks(7798),
                            DescricaoTipoProduto = "Venda",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 23, 55, 48, 374, DateTimeKind.Utc).AddTicks(7822)
                        },
                        new
                        {
                            Id = new Guid("1e11b25a-8bf5-4d57-80b7-396d09cbfcf1"),
                            CreateAt = new DateTime(2024, 6, 12, 23, 55, 48, 374, DateTimeKind.Utc).AddTicks(7823),
                            DescricaoTipoProduto = "Materia Prima",
                            Habilitado = true,
                            UpdateAt = new DateTime(2024, 6, 12, 23, 55, 48, 374, DateTimeKind.Utc).AddTicks(7826)
                        });
                });
