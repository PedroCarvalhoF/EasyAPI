namespace Domain.Models.PessoaModels.PessoaModels
{
    public class PessoasModels
    {
        ...
        public PessoasModels(string? primeiroNome, string? segundoNome, string? rgie, string? cpfcnpj, string? sexo, DateTime dataNascimentoFundacao, Guid? pessoaTipoEntityId)
        {
        ...
        public PessoasModels(Guid idPessoa, string? primeiroNome, string? segundoNome, string? rgie, string? cpfcnpj, string? sexo, DateTime dataNascimentoFundacao, Guid? pessoaTipoEntityId)
        {
            Id = idPessoa;
            PrimeiroNome = FormartarNome(primeiroNome);
            SegundoNome = segundoNome;
