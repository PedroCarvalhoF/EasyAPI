...
namespace Domain.Models.ItemPedidoModels
{
    ...
    {
        public ItemPedidoModel(Guid produtoEntityId, decimal quatidade, decimal preco, decimal desconto, string? observacaoItem, Guid pedidoEntityId, Guid usuarioRestroId)
        {
